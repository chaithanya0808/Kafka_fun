    ...
    def publish_data_to_kafka(self, table_name):
        ...
        spark = SparkSession.builder \
            ...
            .config("spark.driver.extraClassPath",
                    "C:\\Users\\Admin\\Downloads\\sqljdbc_12.4.1.0_enu\\sqljdbc_12.4\\enu\\jars\\mssql-jdbc-12.4.1.jre8.jar") \
        ...
        jdbc_url = "jdbc:sqlserver://localhost:1433;databaseName=initial;integratedSecurity=true;"
        properties = {
